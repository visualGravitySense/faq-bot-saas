...
const items = [
  {
    ...
    description:
      'Advanced semantic search using Sentence Transformers for accurate, context-aware responses to student questions.',
  ...
  },
  {
    ...
    description:
      'Support for Russian, English, and Estonian languages with automatic content translation and localization.',
  ...
  },
  {
    ...
    description:
      'Real-time insights into bot performance, user interactions, and educational content effectiveness.',
  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        >
          Our FAQ Bot SaaS platform offers cutting-edge AI technology with multi-channel
          deployment, comprehensive analytics, and seamless integration for educational institutions.
        </Typography>
      </Box>
      <Box
        sx={{
